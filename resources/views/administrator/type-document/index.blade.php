    ...
    <div class="box-body">
      ...
      @foreach ($document as $type)
          <tr>
            ...
            <td width="20%">
                <a class="btn btn-xs btn-info" href="{{ route('admin.type-document.show',$type->id) }}">
                ...
                <div class="modal fade" id="roleModalEdit-{{ $type->id }}" tabindex="-1" role="dialog" aria-labelledby="roleModalEdit-{{ $type->id }}">
                   @include('administrator.type-document.edit_modal')
                </div>
     ...
     <div class="box-footer clearfix">
      ...
      <div class="modal fade" id="roleModal" tabindex="-1" role="dialog" aria-labelledby="roleModal">
         @include('administrator.type-document.create_modal')
      </div>
  </div>
@endsection